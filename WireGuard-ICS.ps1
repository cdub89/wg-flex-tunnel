...
$logFile = "C:\Users\chris\wg-flex-tunnel\vpn_log.txt"
...
try {
	...
	foreach ($s in $services) {
        ...
        #Write-Log "Waiting 3 seconds for adapter initialization..."
        #Start-Sleep -Seconds 3  # Gives the COM object time to see the new tunnel
	...
	Write-Log "COMPETE: WireGuard-ICS Post Up Process Complete."
	...
	Write-Log "COMPETE: WireGuard-ICS Post Down Process Complete."
    }
} catch {
